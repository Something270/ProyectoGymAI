...
class Agent():
    ...
    #Ajustes y variables para el agente
    ...
    def __init__(self,possible_actions,starting_mem_len,max_mem_len,starting_epsilon,learn_rate, starting_lives = 5, debug = False):
     ...
     #Construye un red neuronal convulucional para el agente
    ...
    #Realiza acciones y determina cual es el indicado y aprende        
    ...
    def _index_valid(self,index):
     ...
     #Aprende y hace memoria de los acciones que brindan recompensas para el agente
